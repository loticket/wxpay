...
import (
	...
	"github.com/loticket/wxpay/auth"
	"github.com/loticket/wxpay/consts"
	"github.com/loticket/wxpay/errors"
	"github.com/loticket/wxpay/option"
	"github.com/loticket/wxpay/setting"
)
...
func (client *Client) doRequest(ctx context.Context, method, requestURL, contentType, reqBody, signBody string) (*http.Response, error) {
	var err error
