...
//解析字符串样式的私钥
func (c *PayOrder) PaserPrivateKey() (*rsa.PrivateKey,error) {
...
func  (c *PayOrder) PaserCertificate() (*x509.Certificate,error) {
	var keyTemplate string   = `
-----BEGIN CERTIFICATE-----
%s
-----END CERTIFICATE-----`
...
//初始化请求客户端
func (c *PayOrder) NewClient()(*client.Client,error) {
...
type Wxpay interface {
	ClientOption(pay PayOrder)
	Pay(out_trade_no string,amount int64,openid string,description string,attach string)(map[string]interface{},error)
}